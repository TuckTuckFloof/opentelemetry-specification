...
public:
   ...
   *
   * @param parent_context a const pointer of the SpanReference of a parent Span.
  ...
  virtual SamplingResult ShouldSample(const trace_api::SpanReference *parent_context,
